...
solutionFile = r"Buddy.Nancy.sln"

projectFiles = [
    r"Buddy.Nancy45\Buddy.Nancy45.csproj", 
    r"Buddy.Nancy451\Buddy.Nancy451.csproj",  
    r"Buddy.Nancy452\Buddy.Nancy452.csproj",  
    r"Buddy.Nancy46\Buddy.Nancy46.csproj",  
    r"Buddy.Nancy461\Buddy.Nancy461.csproj"
]

testProjectFiles = [
    r"Buddy.Nancy45.Test\Buddy.Nancy45.Test.csproj"
]

packageFiles = [
    r"nuspec\Buddy.Nancy.nuspec"
]
